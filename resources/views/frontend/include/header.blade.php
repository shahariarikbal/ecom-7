                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="#" class="product-image">
                                            <img src="{{ asset('/product/'.$data->product?->image) }}" alt="product">
                                        </a>
                                    </figure>
                                    <a href="{{ url('/remove/cart/product/'.$data->id) }}" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                </div><!-- End .product -->
                                @php
                                    $sum += $data->price
                                @endphp
